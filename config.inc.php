...
// Database hostname
$phpAds_config['dbhost'] = XOOPS_DB_HOST;

// Database port
$phpAds_config['dbport'] = 3306;

// Database username
$phpAds_config['dbuser'] = XOOPS_DB_USER;

// Database password
$phpAds_config['dbpassword'] = XOOPS_DB_PASS;

// Database name
$phpAds_config['dbname'] = XOOPS_DB_NAME;

// Database table names
$phpAds_config['tbl_adclicks'] = XOOPS_DB_PREFIX . '_phpads_adclicks';
$phpAds_config['tbl_adviews'] = XOOPS_DB_PREFIX . '_phpads_adviews';
$phpAds_config['tbl_adstats'] = XOOPS_DB_PREFIX . '_phpads_adstats';
$phpAds_config['tbl_banners'] = XOOPS_DB_PREFIX . '_phpads_banners';
$phpAds_config['tbl_clients'] = XOOPS_DB_PREFIX . '_phpads_clients';
$phpAds_config['tbl_session'] = XOOPS_DB_PREFIX . '_phpads_session';
$phpAds_config['tbl_acls'] = XOOPS_DB_PREFIX . '_phpads_acls';
$phpAds_config['tbl_zones'] = XOOPS_DB_PREFIX . '_phpads_zones';
$phpAds_config['tbl_config'] = XOOPS_DB_PREFIX . '_phpads_config';
$phpAds_config['tbl_affiliates'] = XOOPS_DB_PREFIX . '_phpads_affiliates';
$phpAds_config['tbl_images'] = XOOPS_DB_PREFIX . '_phpads_images';
$phpAds_config['tbl_userlog'] = XOOPS_DB_PREFIX . '_phpads_userlog';
$phpAds_config['tbl_cache'] = XOOPS_DB_PREFIX . '_phpads_cache';
$phpAds_config['tbl_targetstats'] = XOOPS_DB_PREFIX . '_phpads_targetstats';

// Database table name prefix
$phpAds_config['table_prefix'] = XOOPS_DB_PREFIX . '_phpads_';
...
$phpAds_config['url_prefix'] = XOOPS_URL . '/modules/phpadsnew';

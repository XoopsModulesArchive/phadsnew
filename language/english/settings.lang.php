...
$GLOBALS['strUpdateDatabaseError'] = "Due to unknown reasons the update of the database structure wasn't succesful. The recommended way to proceed is to click <b>Retry updating</b> to try to correct these potential problems. If you are sure these errors won't affect the functionality of "
                                           . $phpAds_productname
                                           . ' you can click <b>Ignore errors</b> to continue. Ignoring these errors may cause serious problems and is not recommended!';
...
$GLOBALS['strCouldNotConnectToDB'] = 'Could not connect to the database, please recheck the settings you specified. Also make sure that a database with the name you specified already exists on the database server. '
                                           . $phpAds_productname
                                           . ' will not create the database for you, you must create it manually before running the installer.';
...
$GLOBALS['strCacheLockedDetected'] = 'You are using Files delivery caching and '
                                           . $phpAds_productname
                                           . " has detected that the <b>cache</b> directory is not writeable by the server. You can't proceed until you change permissions of the folder. Read the supplied documentation if you don't know how to do that.";
...
$GLOBALS['strInstallMessageDatabase'] = $phpAds_productname
                                        . ' uses a '
                                        . $phpAds_dbmsname
                                        . ' database store the inventory and all of the statistics. Before you can continue you need to tell us which server you want to use and which username and password '
                                        . $phpAds_productname
                                        . ' needs to use to contact the server. If you do not know which information you should provide here, please contact the administrator of your server.';
...
$GLOBALS['strDayFullNames'] = ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'];
$GLOBALS['strEditConfigNotPossible'] = 'It is not possible to edit these settings because the configuration file is locked for security reasons. ' . 'If you want to make changes, you need to unlock the config.inc.php file first.';
$GLOBALS['strEditConfigPossible'] = 'It is possible to edit all settings because the configuration file is not locked, but this could lead to security leaks. ' . 'If you want to secure your system, you need to lock the config.inc.php file.';

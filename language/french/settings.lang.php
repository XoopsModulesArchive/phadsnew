...
$GLOBALS['strUpdateDatabaseError'] = 'Une erreur non identifiée étant survenue, la structure de la base de données n\'a pas pu être mise à jour. Il est recommandé de cliquer sur <b>Retenter la mise à jour</b>, afin d\'essayer de corriger ces problèmes potentiels; néanmoins, si vous êtes sur que ces erreurs ne vont pas affecter la bonne marche de '
                                           . $phpAds_productname
                                           . ', vous pouvez cliquer sur <b>Ignorer les erreurs</b> et continuer. Ignorer ces erreurs peut entrainer de graves problèmes !';
...
$GLOBALS['strFixProblemsBefore'] = 'Le(s) chose(s) suivante(s) doivent être corrigée(s) avant que vous ne puissiez installer '
                                           . $phpAds_productname
                                           . '. Si vous avez des questions à propos de ce message d\'erreur, lisez le <i>Guide de l\'administrateur</i> (Administrator guide, en anglais), qui est fourni avec l\'archive que vous avez téléchargée.';
...
$GLOBALS['strInstallSuccess'] = '<b>L\'installation de '
                                . $phpAds_productname
                                . ' est maintenant terminée.</b><br><br>Afin que '
                                . $phpAds_productname
                                . ' fonctionne '
                                ...
                                . 'configuration, d\'où vous pourrez finir de paramètrer '
                                . $phpAds_productname
                                . '. Veuillez à ne pas oublier de protéger contre '
                                . 'l\'écriture le fichier <i>config.inc.php</i> lorsque vous aurez fini, afin de sécuriser '
                                . $phpAds_productname
                                . '.';

$GLOBALS['strUpdateSuccess'] = '<b>La mise à niveau de '
                                       . $phpAds_productname
                                       . ' a réussie.</b><br><br>Afin que '
                                       . $phpAds_productname
                                       ...
                                       . 'à l\'interfaçe de configuration, d\'où vous pourrez finir de paramétrer '
                                       . $phpAds_productname
                                       . '. Veuillez à ne pas oublier '
                                       . 'de protéger en écriture le fichier <i>config.inc.php</i> lorsque vous aurez fini, afin de sécuriser '
                                       . $phpAds_productname
                                       . '.';
$GLOBALS['strInstallNotSuccessful'] = '<b>L\'installation de '
                                       . $phpAds_productname
                                       . ' a échouée</b><br><br>Certaines partie du processus d\'installation n\'ont pas pu '
...
$GLOBALS['strDayFullNames'] = ['Dimanche', 'Lundi', 'Mardi', 'Mercredi', 'Jeudi', 'Vendredi', 'Samedi'];
$GLOBALS['strEditConfigNotPossible'] = 'Il n\'est pas possible d\'éditer ces paramètres, le fichier de configuration étant en lecture seule pour des raisons de sécurité. ' . 'Si vous souhaitez faire des changements, vous devez d\'abord changer les droits du fichier config.inc.php.';

...
$GLOBALS['strMonth'] = ['Janvier', 'Février', 'Mars', 'Avril', 'Mai', 'Juin', 'Juillet', 'Août', 'Septembre', 'Octobre', 'Novembre', 'Décembre'];
$GLOBALS['strDayShortCuts'] = ['Dim', 'Lun', 'Mar', 'Mer', 'Jeu', 'Ven', 'Sam'];
...
$GLOBALS['strHighPriority'] = 'Montrer les bannières de cette campagne avec une priorité haute.<br> Si vous utilisez cette option, ' . $phpAds_productname . ' essayera de répartir les affichages uniformément sur la durée totale de la campagne.';
$GLOBALS['strLowPriority'] = 'Montrer les bannières de cette campagne avec une priorité basse.<br> Les affichages de cette campagne seront répartis en' . 'fonction des objectifs  des campagne ayant une priorité haute.';
$GLOBALS['strTargetLimitAdviews'] = 'Limiter le nombre d\'affichages à ';
$GLOBALS['strTargetPerDay'] = 'par jour.';
$GLOBALS['strPriorityAutoTargeting'] = 'Répartir les affichages restant de façon uniforme sur la durée restante.<br> Le nombre d\'affichage par jour sera' . 'automatiquement calculé.';
...
$GLOBALS['strConvertSWF'] = '<br>L\'animation Flash que vous avez choisie contient des liens codés en dur. '
                                 . $phpAds_productname
                                 . ' ne pourra '
                                 ...
                                 . $phpAds_productname
                                 . ' essaye de convertir ces liens, choisissez <b>Convertir</b>, autrement'
                                 . '<b>Annulez</b>.<br><br>'
                                 . 'Veuillez noter : si vous demandez à '
                                 . $phpAds_productname
                                 . ' de convertir l\'animation Flash, elle sera modifiée. '
...
$GLOBALS['strErrorDBSubmitBug'] = 'Si ce problème est reproductible, il pourrait être causé par un bug de '
                                      . $phpAds_productname
                                      . '. Merci d\'envoyer les informations suivantes aux créateurs de '
                                      . $phpAds_productname
                                      . '. Dans votre message, essayez aussi de décrire le plus clairement possible les actions que vous avez effectuées et qui ont conduit à cette erreur (NdT: merci de leur écrire en anglais. Si vous ne pouvez, envoyez votre message au traducteur français, qui transmettra).';
$GLOBALS['strMaintenanceNotActive'] = 'Le script de maintenance n\'a pas été exécuté dans les dernières 24 heures. \nAfin que '
                                      . $phpAds_productname
                                      . ' puisse fonctionner, il doit être exécuté \n chaque heure. \n\nLisez le Guide de l\'Administrateur pour plus d\'informations \nconcernant le script de maintenance.';

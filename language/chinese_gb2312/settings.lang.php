...
$GLOBALS['strDayFullNames']          = ['星期日', '星期一', '星期二', '星期三', '星期四', '星期五', '星期六'];
...
$GLOBALS['strCacheSysvshm']       = '共享内存/Sysvshm';
$GLOBALS['strExperimental']       = '实验性的';
...
$GLOBALS['strTypeFTPErrorDir']     = '主机目录不存在';
$GLOBALS['strTypeFTPErrorConnect'] = "不能连接到FTP服务器,用户名或者密码错?;
$GLOBALS['strTypeFTPErrorHost']			= "FTP服务器主机主机名错误";
$GLOBALS['strTypeDirError']			= "本地目录不存在";
...
$GLOBALS['strGeotrackingLocationNoHTTP'] 	= "您指定的位置并不是此服务器硬盘上的本地目录,而是一个指向网页服务器上的某个文件的URL . 这个位置应该象这样: < i > {
    example} < / i > .实际的位置要看存放此数据库的位置 . ";
...
$GLOBALS['strWarnAdmin']			= "每次当一个项目快过期的时候给管理员发送一个警告信息";
$GLOBALS['strWarnClient']			= "每次当一个项目快过期的时候给客户发送一个警告信息";
...
$GLOBALS['strMyHeader']				= "页面顶部文件所在位置";
$GLOBALS['strMyHeaderError']			= "在您指定的位置没有找到页面顶部文件所在位置";
$GLOBALS['strMyFooter']				= "页面底部文件所在位置";
$GLOBALS['strMyFooterError']			= "在您指定的位置没有找到页面底部文件所在位置";

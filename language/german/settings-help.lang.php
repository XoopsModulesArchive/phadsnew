...
$GLOBALS['phpAds_hlp_dbport'] = '
        Geben Sie die Port-Nummer für den Datenbank-Server von ' . $phpAds_dbmsname . ' an.. Die Voreinstellung für eine' . $phpAds_dbmsname . '-Datenbank ist <i>' . ('phpAdsNew' == $phpAds_productname ? '3306' : '5432') . '</i>.
		';
...
$GLOBALS['phpAds_hlp_auto_clean_userlog'] = $GLOBALS['phpAds_hlp_auto_clean_userlog_interval'] = '
...
$GLOBALS['phpAds_hlp_allow_invocation_plain'] = $GLOBALS['phpAds_hlp_allow_invocation_js'] = $GLOBALS['phpAds_hlp_allow_invocation_frame'] = $GLOBALS['phpAds_hlp_allow_invocation_xmlrpc'] = $GLOBALS['phpAds_hlp_allow_invocation_local'] = $GLOBALS['phpAds_hlp_allow_invocation_interstitial'] = $GLOBALS['phpAds_hlp_allow_invocation_popup'] = '
...
$GLOBALS['phpAds_hlp_default_banner_url'] = $GLOBALS['phpAds_hlp_default_banner_target'] = '
...
$GLOBALS['phpAds_hlp_delivery_caching'] = '
		Die Verwendung eines Caches als Zwischenspeicher beschleunigt die Bannerauslieferung. In dem Cache sind alle Informationen, die für die Bannerauslieferung notwendig sind, hinterlegt. Als Voreinstellung ist der Cache Teil der Datenbank. Alternativ hierzu kann er in einer Datei oder in einem shared memory abgelegt werden. Die schnellste Bannerauslieferung bietet shared memory; doch bereits der Einsatz einer Datei beschleunigt die Bannerauslieferung erheblich. Wird die Option des Caches für die Bannerauslieferung deaktiviert, verlangsamt sich die Leistung von'
                                          . $phpAds_productname
                                          . ' sehr und wird daher nicht empfohlen.
		';

$GLOBALS['phpAds_hlp_type_sql_allow'] = $GLOBALS['phpAds_hlp_type_web_allow'] = $GLOBALS['phpAds_hlp_type_url_allow'] = $GLOBALS['phpAds_hlp_type_html_allow'] = $GLOBALS['phpAds_hlp_type_txt_allow'] = '
...
$GLOBALS['phpAds_hlp_type_web_dir'] = '
	In das hier festgelegte Verzeichnis speichert '
                                      . $phpAds_productname
                                      . ' die hochgeladenen Banner. Das Verzeichnis darf für PHP nicht schreibgeschützt sein. Es muß, ggf. mit Hilfe eines FTP-Programmes, die Zugriffs- und Schreibberechtigung gesetzt werden. Das Verzeichnis muß im Root-Verzeichnis von '
                                      . $phpAds_productname
                                      . ' sein. Bei der Eingabe des Verzeichnisses darf als Ende kein  Slash (/) eingegeben werden. Diese Angaben werden nur bei  <i>Lokales Verzeichnis</i> als Wahl für die Speicherung benötigt.
		';
...
$GLOBALS['phpAds_hlp_admin_pw'] = $GLOBALS['phpAds_hlp_admin_pw2'] = '
	Bitte geben Sie ein Kennwort für den Administrator ein. Die Kennworteingabe muß durch erneute Eingabe bestätigt werden.
		';

$GLOBALS['phpAds_hlp_pwold'] = $GLOBALS['phpAds_hlp_pw'] = $GLOBALS['phpAds_hlp_pw2'] = '

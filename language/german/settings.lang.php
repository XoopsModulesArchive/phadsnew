...
$GLOBALS['strChooseInstallLanguage'] = 'Wählen Sie die Sprache für den Installationsproze&szlig;';
...
$GLOBALS['strUpdateDatabaseError'] = 'Aus unbekannten Gründen war die Aktualisierung der Datenbankstruktur nicht erfolgreich. Es wird empfohlen, zu versuchen, mit <b>Wiederhole Update</b> das Problem zu beheben. Sollte der Fehler - Ihrer Meinung nach - die Funktionalität von '
                                           . $phpAds_productname
                                           . ' nicht berühren, können Sie durch <b>Fehler ignorieren</b>  fortfahren. Das Ignorieren des Fehlers wird nicht empfohlen!';
...
$GLOBALS['strCouldNotConnectToDB'] = 'Verbindung zur Datenbank war nicht möglich. Bitte vorgenommene Einstellung prüfen. Prüfen Sie ggf., ob die von Ihnen angegebene Datenbank überhaupt auf dem Datenbank-Server vorhanden ist. '
                                           . $phpAds_productname
                                           . ' erstellt die Datenbank  <i>nicht</i> automatisch. ';
...
$GLOBALS['strFixProblemsBefore'] = 'Folgende Teile müssen korrigiert werden, bevor der Installationsproze&szlig; von ' . $phpAds_productname . ' fortgesetzt werden kann. Informationen über Fehlermeldungen finden sich im Handbuch.';
...
$GLOBALS['strConfigLockedDetected'] = $phpAds_productname . ' hat erkannt, da&szlig; die Datei <b>config.inc.php</b> schreibgeschützt ist.<br> Die Installation kann aber ohne Schreibberechtigung nicht fortgesetzt werden. <br>Weitere Informationen finden sich im Handbuch.';
...
$GLOBALS['strInstallSuccess'] = '<b>die Installation von ' . $phpAds_productname . ' war erfolgreich.</b><br><br>Damit ' . $phpAds_productname . ' korrekt arbeitet, mu&szlig; sichergestellt sein, da&szlig; das Wartungsmodul (maintenance.php) stündlich aktiviert wird. Nähere Informationen finden sich im Handbuch. <br><br>
...
Damit ' . $phpAds_productname . ' korrekt arbeitet, mu&szlig; sichergestellt sein, da&szlig; das Wartungsmodul (maintenance.php) stündlich aktiviert wird. Nähere Informationen finden sich im Handbuch. <br><br>
Für weitere Einstellungen auf der Konfigurationsseite drücken Sie  <b>Weiter</b>. 
<BR>
...
Teile des Installationsprozesses wurden nicht beendet. Das Problem ist möglicherweise nur temporär. In diesem Fall drücken Sie <b> Weiter</b> und beginnen Sie den Installationsproze&szlig; von neuem. Näheres zu Fehlermeldungen und -behebung findet sich im Handbuch.';
...
$GLOBALS['strSystemNeedsUpgrade'] = 'Die Datenbankstruktur und die Konfigurationsdateien sollten aktualisiert werden. Drücken Sie <b>Weiter</b> für den Start des Aktualisierungslauf.
 <br><br>Abhängig von der derzeitig genutzten Version und der Anzahl der vorhandenen Statistiken kann dieser Proze&szlig; Ihre Datenbank stark belasten. Das Upgrade kann einige Minuten dauern.';
...
$GLOBALS['strPhpBug20144'] = "Die von Ihnen eingesetzte Version von PHP hat einen <a href='http://bugs.php.net/bug.php?id=20114' target='_blank'>schwerwiegenden Fehler</a>. Dadurch arbeitet "
                                   . $phpAds_productname
                                   . ' nicht korrekt. Es wird PHP 4.3.0 oder höher benötigt. Andernfalls kann die Installation nicht fortgesetzt werden.';
...
$GLOBALS['strDayFullNames'] = ['Sonntag', 'Montag', 'Dienstag', 'Mittwoch', 'Donnerstag', 'Freitag', 'Samstag'];
$GLOBALS['strEditConfigNotPossible'] = 'Änderungen der Systemeinstellung sind nicht möglich. Es besteht für die Konfigurationsdatei  <i>config.inc.php</i> Schreibschutz. ' . 'Für Änderungen mu&szlig; der Schreibschutz aufgehoben werden.';
$GLOBALS['strEditConfigPossible'] = 'Unbefugte Systemänderungen sind möglich. Die Zugriffsrechte der Konfigurationsdatei <i>config.inc.php</i> sind auf Schreibbrechtigung gesetzt. ' . 'Zur Sicherung des System sollte der Schreibschutz gesetzt werden. Nähere Informationen im Handbuch.';
...
Um Geotargeting nutzen zu können, mu&szlig; korrekt angegeben werden, wohin die Datenbank kopiert wurde. ';
...
$GLOBALS['strLogBeacon'] = ' Ein Beacon (Minibild) wird verwendet, um sicherzustellen, da&szlig; nur vollständige Bannerauslieferungen protokolliert werden ';
...
$GLOBALS['strAutoCleanErr'] = 'Der Zeitraum, nach dem die Daten gelöscht werden sollen, mu&szlig; mindestens 3 Wochen betragen';
...
$GLOBALS['strMyFooterError'] = 'Die Datei für die Fu&szlig;zeile wurde an angegebenen Adresse nicht vorgefunden';
$GLOBALS['strGzipContentCompression'] = 'Komprimieren mit GZIP';

$GLOBALS['strClientInterface'] = 'Inserentenbereich';
$GLOBALS['strClientWelcomeEnabled'] = 'Begrü&szlig;ungstext für Inserenten verwenden';
$GLOBALS['strClientWelcomeText'] = 'Begrü&szlig;ungstext<br><i>(HTML Tags sind zugelassen)</i>';
...
$GLOBALS['strDefaultBannerWErr'] = 'Voreinstellung für Bannergewichtung mu&szlig; eine positive Ganzzahl sein';
$GLOBALS['strDefaultCampaignWErr'] = ' Voreinstellung für Kampagne mu&szlig; eine positive Ganzzahl sein';

...
$GLOBALS['strMonth'] = ['Januar', 'Februar', 'März', 'April', 'Mai', 'Juni', 'Juli', 'August', 'September', 'Oktober', 'November', 'Dezember'];
$GLOBALS['strDayShortCuts'] = ['So', 'Mo', 'Di', 'Mi', 'Do', 'Fr', 'Sa'];
...
$GLOBALS['strErrorDBSubmitBug'] = 'Wenn das Problem wiederholt auftritt, kann es ein Fehler in '
                                      . $phpAds_productname
                                      . ' sein. Bitte protokollieren Sie die Fehlermeldung uns senden sie diese an die Programmierer von '
                                      . $phpAds_productname
                                      . '. Bitte beschreiben Sie alle Aktivitäten, die zu diesem Fehler führten.';
$GLOBALS['strMaintenanceNotActive'] = 'Das Wartungsprogramm lief während der letzen 24 Stunden nicht. \\nDamit '
                                      . $phpAds_productname
                                      . ' korrekt arbeiten kann, mu&szlig; das Wartungsprogramm stündlich \\naufgerufen werden. \\n\\nIm Handbuch finden sich weitere Informationen \\nzur Konfiguration des Wartungsprogrammes.';

...
$GLOBALS['strUpdateDatabaseError'] = 'Disebabkan oleh masalah yang tidak jelas update dari struktur database tidak berhasil. Disarankan untuk klick <b>Retry updating</b> untuk mencoba membenarkan masalah ini. Bila Anda yakin bahwa masalah ini tidak akan berpengaruh fungsi-fungsi dari '
                                           . $phpAds_productname
                                           . ', silakan klick <b>Ignore errors</b> untuk melanjutkan. Abaikan masalah ini mampuh untuk mengakibatkan masalah yang serius dan maka dengan itu tidak disarankan!';
...
$GLOBALS['strConfigLockedDetected'] = $phpAds_productname
                                           . ' telah deteksi bahwa file <b>config.inc.php</b> tidak bisa ditulis oleh server.<br> Anda tidak bisa melanjutkan sebelum hak terhadap file tersebut belum diubah. <br>Silakan belajari dokumentasi yang berkaitan bila Anda belum memahaminya.';
...
$GLOBALS['strDayFullNames'] = ['Minggu', 'Senin', 'Selasa', 'Rabu', 'Kamis', 'Jumat', 'Sabtu'];
$GLOBALS['strEditConfigNotPossible'] = 'Perubahan tidak diperbolehkan sehubungan file konfigurasi terkunci didasarkan alasan keamanan. ' . 'Bila Anda ingin melakukan perubahan, Anda perlu membuka file config.inc.php terlebih dahulu.';
$GLOBALS['strEditConfigPossible'] = 'File konfigurasi dapat diubah sehubungan file tersebut tidak terkunci. Hal ini memungkinkan kebobolan dalam segi keamanan. ' . 'Bila Anda ingin mengamankan sistem, Anda perlu mengunci file config.inc.php.';

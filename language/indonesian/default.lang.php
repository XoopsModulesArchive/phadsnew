...
$GLOBALS['strMonth'] = ['Januari', 'Februari', 'Maret', 'April', 'Mei', 'Juni', 'Juli', 'Agustus', 'September', 'Oktober', 'November', 'Desember'];
$GLOBALS['strDayShortCuts'] = ['Min', 'Sen', 'Sel', 'Rab', 'Kam', 'Jum', 'Sab'];
$GLOBALS['strHour'] = 'Jam';
...
$GLOBALS['strErrorDBSubmitBug'] = 'Bila masalah ini bisa diulang-ulang, ada kemungkinan hal ini disebabkan oleh sebuah bug pada '
                                      . $phpAds_productname
                                      . '. Mohon laporkan informasi berikut ini kepada pencipta dari program '
                                      . $phpAds_productname
                                      . '. Mohon berikan deskripsi tentang sejarah masalah ini secara rinci.';
$GLOBALS['strMaintenanceNotActive'] = 'Skript Pemeliharaan <i>(Maintenance)</i> tidak dijalankan dalam waktu 24 jam terakhir. \\nUntuk menjaminkan '
                                      . $phpAds_productname
                                      . ' berfungsi semestinya, skript Pemeliharaan perlu dijalankan \\setiap jam. \\n\\nMohon belajari <i>Administrator Guide</i> untuk informasi lebih lanjut \\ntentang caranya untuk mengkonfigurasi skript Pemeliharaan.';

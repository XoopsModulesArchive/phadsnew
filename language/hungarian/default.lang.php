...
$GLOBALS['strMonth'] = ['Január', 'Február', 'Március', 'Április', 'Május', 'Június', 'Július', 'Augusztus', 'Szeptember', 'Október', 'November', 'December'];
$GLOBALS['strDayShortCuts'] = ['Va', 'He', 'Ke', 'Sz', 'Cs', 'Pe', 'Szo'];
$GLOBALS['strHour'] = 'Óra';
...
$GLOBALS['strErrorDBSubmitBug'] = 'Ha ez a probléma megismételhetõ, akkor lehet, hogy a '
                                      . $phpAds_productname
                                      . ' hibája okozta. Jelentse a következõ adatokat a '
                                      . $phpAds_productname
                                      . ' fejlesztõinek. Amennyire csak lehet, próbálja meg pontosan ismertetni azokat a mûveleteket, melyek ezt a hibát okozták.';
$GLOBALS['strMaintenanceNotActive'] = 'Az utóbbi 24 órában nem történt meg a karbantartás parancsfájl futtatása. \\nA '
                                      . $phpAds_productname
                                      . ' megfelelõ mûködéséhez óránként futtatás szükséges. \\n\\nAz Administrator guide kézikönyvben részletes tájékoztatót olvashat \\na karbantartás parancsfájl beállításáról.';

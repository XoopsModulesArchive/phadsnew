...
$GLOBALS['strUpdateDatabaseError'] = 'Ismeretlen okból kifolyólag az adatbázis szerkezet frissítése nem sikerült. Végrehajtásának javasolt módja a <b>Frissítés újrapróbálására</b> kattintás, amivel megpróbálhatja kijavítani e lehetséges problémákat. Ha ön biztos abban, hogy ezek a hibák nincsenek kihatással a '
                                           . $phpAds_productname
                                           . ' mûködésére, akkor a <b>Hibák kihagyása</b> választásával folytathatja. Ezeknek a hibáknak a figyelmen kívül hagyása komoly problémákat okozhat, és nem ajánlott!';
...
$GLOBALS['strDayFullNames'] = ['Vasárnap', 'Hétfõ', 'Kedd', 'Szerda', 'Csütörtök', 'Péntek', 'Szombat'];
$GLOBALS['strEditConfigNotPossible'] = 'Ezek a beállítások nem módosíthatók, mert a konfigurációs fájl biztonsági okokból zárolva van. ' . 'Ha szeretné módosítani, akkor elõbb oldja fel a config.inc.php fájlt.';
$GLOBALS['strEditConfigPossible'] = 'A beállítások módosíthatók, mert nem zárta le a konfigurációs fájlt, ez viszont így biztonsági rést jelent. ' . 'Ha szeretné biztonságossá tenni a rendszert, akkor zárja le a config.inc.php fájlt.';

...
$GLOBALS['strUpdateDatabaseError'] = 'Z nieznanych powodów aktualizacja struktury bazy danych nie powiod³a siê. Rekomendowan± drog± postêpowania w tej sytuacji jest klikniêcie <b>Ponowna aktualizacja</b> aby spróbowaæ naprawiæ potencjalne problemy. Je¶li jeste¶ pewien, ¿e b³êdy nie bêd± mia³y wp³ywu na funkcjonowanie  '
                                           . $phpAds_productname
                                           . ' mo¿esz klikn±æ <b>Zignoruj b³êdy</b> aby kontynuowaæ. Zignorowanie tych b³êdów mo¿e byæ przyczyn± powa¿nych problemów i nie jest polecane!';
...
$GLOBALS['strFixProblemsBefore'] = 'Poni¿sze elementy musz± zostaæ skorygowane zanim bêdziesz móg³ zainstalowaæ '
                                           . $phpAds_productname
                                           . '. Je¶li masz pytania dotycz±ce tej informacji o b³êdzie przeczytaj <i>Podrêcznik administratora</i>, który jest czê¶ci± ¶ci±gnietego przez ciebie pakietu.';
...
$GLOBALS['strDayFullNames'] = ['Niedziela', 'Poniedzia³ek', 'Wtorek', '¦roda', 'Czwartek', 'Pi±tek', 'Sobota'];
$GLOBALS['strEditConfigNotPossible'] = 'Zmiana tych ustawieñ nie jest mo¿liwa, poniewa¿ plik konfiguracji jest zablokowany ze wzglêdów bezpieczeñstwa. ' . 'Je¶li chcesz dokonaæ zmian, musisz najpierw odblokowaæ plik config.inc.php.';
$GLOBALS['strEditConfigPossible'] = 'Edycja wszystkich ustawieñ jest mo¿liwa, poniewa¿ plik konfiguracyjny nie jest zablokowany, co mo¿e prowadziæ do zagro¿enia bezpieczeñstwa. ' . 'Je¶li chcesz zabezpieczyæ swój system, zablokuj plik config.inc.php.';

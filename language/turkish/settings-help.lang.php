...
$GLOBALS['phpAds_hlp_dbhost'] = $phpAds_dbmsname . ' veritabanýnýn veritabaný sunucusunu belirtiniz.
		';

$GLOBALS['phpAds_hlp_dbuser'] = $phpAds_productname . ' programýnýn ' . $phpAds_dbmsname . ' veritabanýna baðlanmasý için kullanýcý adýný belirtiniz.
		';

$GLOBALS['phpAds_hlp_dbpassword'] = $phpAds_productname . ' programýnýn ' . $phpAds_dbmsname . ' veritabanýna baðlanmasý için parolanýzý belirtiniz.
		';

$GLOBALS['phpAds_hlp_dbname'] = $phpAds_productname . ' programýnýn verilerini saklayacaðý veritabanýný belirtiniz.
		';

...
$GLOBALS['strDayFullNames']          = ['Pazar', 'Pazartesi', 'Salý', 'Çarþamba', 'Perþembe', 'Cuma', 'Cumartesi'];
$GLOBALS['strEditConfigNotPossible'] = 'Ayarlarý düzenleyemiyorsunuz. çünkü ayar dosyanýz güvenlik nedeniyle kilitlenmiþ.<br> ' . 'Düzenleme yapmanýz için, config.inc.php dosyasýnýn kilidini açýnýz.';
$GLOBALS['strEditConfigPossible']    = 'Tüm düzenleme iþlemlerini yapabilirsiniz çünkü ayar dosyasý kilitli deðil, ama bu güvenlik açýklýklarýna sebep olabilir.<br> ' . 'Sisteminizi korumak istiyorsanýz, config.inc.php dosyasýný kilitleyiniz.';

...
$GLOBALS['phpAds_hlp_dbport'] = '
		...
		connettere. La porta di default di ' . $phpAds_dbmsname . ' &egrave; la <i>' . ('phpAdsNew' == $phpAds_productname ? '3306' : '5432') . '</i>.
		';
...
$GLOBALS['phpAds_hlp_gui_hide_inactive'] = '
		...
		saranno nascosti nelle pagine <i>' . $GLOBALS['strClientsAndCampaigns'] . '</i> e <i>' . $GLOBALS['strCampaignOverview'] . '</i>. Sar&agrave; comunque possibile visualizzare gli oggetti

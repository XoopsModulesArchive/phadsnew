...
$GLOBALS['strMonth'] = ['Gennaio', 'Febbraio', 'Marzo', 'Aprile', 'Maggio', 'Giugno', 'Luglio', 'Agosto', 'Settembre', 'Ottobre', 'Novembre', 'Dicembre'];
$GLOBALS['strDayShortCuts'] = ['Do', 'Lu', 'Ma', 'Me', 'Gi', 'Ve', 'Sa'];
$GLOBALS['strHour'] = 'Ora';
...
$GLOBALS['strErrorDBSubmitBug'] = 'Se questo problema &egrave; riproducibile, potrebbe essere causato da un bug di '
                                      . $phpAds_productname
                                      . '. Per favore sottoponi le informazioni sottostanti ai creatori di '
                                      . $phpAds_productname
                                      . '. Tenta inoltre di descrivere le azioni che hanno portato a questo errore il pi&ugrave; chiaramente possible.';
$GLOBALS['strMaintenanceNotActive'] = 'Lo script di manutenzione non è stato lanciato nelle ultime 24 ore. \\nAffinché '
                                      . $phpAds_productname
                                      . ' funzioni correttamente esso deve essere lanciato \\nogni ora. \\n\\nLa ggere la Administrator guide per maggiori informazioni \\nsu come configurare lo script di manutenzione.';

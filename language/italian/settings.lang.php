...
$GLOBALS['strUpdateDatabaseError'] = "Per motivi sconosciuti l'aggiornamento del database non &egrave; andato a buon fine. &Egrave; consigliato cliccare su <b>Riprova</b> per tentare di correggere questi potenziali problemi. Se sei sicuro che questi errori non influiscano sul corretto funzionamento di "
                                           . $phpAds_productname
                                           . ' clicca su <b>Ignora errori</b> per continuare. Ignorare questi errori pu&ograve; causare seri problemi e non &egrave; consigliato!';
...
$GLOBALS['strCouldNotConnectToDB'] = 'Impossibile connettersi al database, controlla i parametri specificati. Assicurati anche che il database dal nome specificato esista gi&agrave; sul server di database. '
                                           . $phpAds_productname
                                           . " non creer&agrave; il database, deve essere creato manualmente prima di lanciare l'installazione.";
...
$GLOBALS['strCacheLockedDetected'] = "La cache di consegna &egrave; impostata in modalit&agrave; 'File' e "
                                           . $phpAds_productname
                                           . ' ha riscontrato che il server web non &egrave; in grado di scrivere nella directory <b>cache</b>. Non sar&agrave; possibile procedere finch&eacute; non verranno modificati i permessi della cartella. Puoi leggere sul manuale di '
                                           . $phpAds_productname
                                           . ' come fare.';
...
$GLOBALS['strInstallMessageDatabase'] = $phpAds_productname
                                        ...
                                        . $phpAds_dbmsname
                                        . " per salvare l'inventario e tutte le statistiche. Prima di continuare &egrave; necessario specificare quale server utilizzare e il nome utente e la password che "
                                        . $phpAds_productname
                                        . " dovr&agrave; fornire per connettersi al database. Se non sai cosa inserire qui, contatta l'amministratore del server.";
...
$GLOBALS['strDayFullNames'] = ['Domenica', 'Luned&igrave;', 'Martedi&igrave;', 'Mercoled&igrave;', 'Gioved&igrave;', 'Venerd&igrave;', 'Sabato'];
$GLOBALS['strEditConfigNotPossible'] = 'Non risulta possibile modificare queste ipostazioni a causa del file config.inc.php protetto da scrittura per aumentare la sicurezza. ' . 'Se vuoi effettuare cambiamenti devi prima sbloccare il file config.inc.php.';

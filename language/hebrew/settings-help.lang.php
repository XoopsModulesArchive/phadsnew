...
$GLOBALS['phpAds_hlp_dbport'] = '
        ציין את מספר המבוא (port) של בסיס הנתונים ' . $phpAds_dbmsname . ' שאליו אתה מנסה להתחבר. ברירת המחדל של מאגר ' . $phpAds_dbmsname . ' היא <i>' . ('phpAdsNew' == $phpAds_productname ? '3306' : '5432') . '</i>.
		';
...
$GLOBALS['phpAds_hlp_persistent_connections'] = '
        השימוש בחיבור מתמשך יכול להאיץ את '
                                                . $phpAds_productname
                                                . ' בצורה משמעותית ואפילו להפחית מהעומס על השרת. אבל יש בזה חסרון מסוים, שכן באתרים עמוסים במבקרים העומס על השרת עשוי לגדול ולהפוך אפילו לכבד יותר מזה הנוצר בחיבור רגיל. אם תשתמש בחיבור רגיל או מתמשך יהיה תלוי במספר המבקרים והחומרה שבשימוש. אם '
                                                . $phpAds_productname
                                                . ' משתמשת ביותר מדי משאבים, 
...
$GLOBALS['phpAds_hlp_compatibility_mode'] = '
      אם יש לך בעיה בשילוב '
                                            . $phpAds_productname
                                            . ' עם מוצר תוכנה אחר, זה עשוי לעזור אם תסמן את מצב תאימות בסיס הנתונים. אם אתה משתמש בשליפת באנר מקומית (local mode) וסעיף זה מסומן לתאימות, '
                                            . $phpAds_productname
                                            . ' תשאיר את מצב החיבור לבסיס הנתונים בדיוק כפי שהוא היה לפני ש'
                                            . $phpAds_productname
                                            . ' הופעלה. 
...
$GLOBALS['phpAds_hlp_compact_stats'] = '
       בהתחלה '
                                       . $phpAds_productname
                                       . ' עשתה שימוש מסיבי בתיעוד, אשר מטבעו מכיל כמות עצומה של פרטים, אך גם מכביד ביותר על בסיס הנתונים. זה עלול ליצור בעיה רצינית באתרים עמוסי מבקרים, וכדי להתגבר על בעיה זו '
                                       . $phpAds_productname
                                       . ' תומכת גם במתקונת חדשה של סטטיסטיקה - סטטיסטיקה קומפקטית, אשר מפחיתה משמעותית את העומס על השרת, אך גם פחות מפורטת כמובן. סטטיסטיקה קומפקטית זו מתעדת רק סטטיסטיקה יומית. אם אתה זקוק לתיעוד בכל שעה, כבה תכונה זו.		';
...
$GLOBALS['phpAds_hlp_type_txt_allow'] = '
        '
                                         . $phpAds_productname
                                         . ' יכולה להשתמש בסוגים שונים של באנרים ולאחסן אותם בדרכים שונות. שתי האופציות הראשונות משמשות לאיחסון מקומי על השרת. אתה יכול להשתמש בממשק המנהל להעלאת באנר ו-'
                                         . $phpAds_productname
                                         . ' תשמור אותו בבסיס הנתונים מסוג SQL או בתוך תיקייה בשרת. תוכל להשתמש גם בבאנר המאוחסן בשרת חיצוני או בקוד HTML שיוצר באנר.		';

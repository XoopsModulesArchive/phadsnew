...
$GLOBALS['strMonth'] = ['ינואר', 'פברואר', 'מרץ', 'אפריל', 'מאי', 'יוני', 'יולי', 'אוגוסט', 'ספטמבר', 'אוקטובר', 'נובמבר', 'דצמבר'];
$GLOBALS['strDayShortCuts'] = ['ר', 'שני', 'של', 'רב', 'חמ', 'שי', 'שב'];
$GLOBALS['strHour'] = 'שעה';
...
$GLOBALS['strConvertSWF'] = '<br>קובץ ה-Flash שזה עתה העלת מכיל כתובת הפניית הקלקה מובנית.<br>התוכנה לא תוכל לעקוב אחר מספר ההקלקות אלא אם כתובת זו תומר.<br> למטה תוכל למצוא רשימה של כתובות שאותרו בתוך הקובץ. <br>אם אתה רוצה להמיר את הכתובות לחץ על <B>המר</B>, או לחץ על <B>בטל</B><br><br>'
                                 . 'שים לב: אם אתה לוחץ על <B>המר</B>, קובץ הפלאש שזה עכשיו העלת ישונה בצורה פיזית. <br>אנא שמור לך עותק מקורי שלו כגיבוי.<br> לא משנה באיזו גירסה פלאש זה נעשה, <br>לתצוגה  נכונה שלו תספיק גירסת נגן Flash 4 (או גבוהה יותר).<br><br> ';

...
$GLOBALS['strBannerCacheExplaination'] = 'זיכרון-מטמון של הבאנרים מכיל כעת העתק של קוד HTML  המשמש לתצוגה של הבאנר. על ידי שימוש בזיכרון זה ניתן להאיץ את ההפצה של הבאנרים כי קוד ה-HTML לא דורש הפקה מחודשת בכל פעם שבאנר צריך להיחשף.<br> מכיוון שזיכרון הבאנר כולל קוד מוטבע של ה-URLs למיקום ה-'
                                         . $phpAds_productname
                                         . ' והבאנרים שלו, הזיכרון צריך להתעדכן בכל פעם שה-'
                                         . $phpAds_productname
                                         . ' מועבר למיקום אחר על השרת. ';

...
$GLOBALS['strUpdateDatabaseError'] = 'מסיבות לא ברורות עדכון בסיס הנתונים לא הצליח. הררך המומלצת להמשיך היא ללחוץ <b>נסה עדכון מחדש</b> כדי לנסות ולתקן בעיות אפשריות. אם אתה בטוח שבעיות אלו לא יכולות לפגוע בתפקוד '
                                           . $phpAds_productname
                                           . ' אתה יכול ללחוץ <b>התעלם משגיאות</b> כדי להמשיך. התעלמות משגיאות אלו אפשר שתיור בעיה חמורה וזה לא מומלץ!';
...
$GLOBALS['strInstallSuccess'] = '<b>ההתקנה של '
                                       . $phpAds_productname
                                       . ' הסתיימה ברגע זה.</b><br><br>כדי ש- '
                                       . $phpAds_productname
                                       . ' תתפקד נכון עליך גם לוודא שקובץ התחזוקה ירוץ כל שעה. מידע נוסף אודות נושא זה ניתן למצוא בתיעוד המצורף. <br><br>לחץ <b>המשך</b> כדי להגיע לעמוד העיצוב/קינפוג, היכן שתוכל לקבוע נתונים נוספים. אנא אל תשכח לנעול את הקובץ <B> config.inc.php</B> ברגע שסיימת, כדי למנוע פגיעות והטרדות בשרת.';
$GLOBALS['strUpdateSuccess'] = '<b>העדכון של '
                                       . $phpAds_productname
                                       . ' הסתיים בהצלחה.</b><br><br>כדי ש-'
                                       . $phpAds_productname
                                       . ' תתפקד נכון עליך גם להבטיח שקובץ התחזוקה ירוץ כל שעה (עד עתה הוא נדרש לרוץ פעם ביום) מידע נוסף בנושא זה ניתן למצוא בתיעוד המצורף. <br><br>לחץ <b>המשך</b> כדי להגיע לעמוד ממשק ההנהלה. אנא אל תשכח לנעול את הקובץ  <B>config.inc.php</B> למניעת בעיות אבטחה.';
$GLOBALS['strInstallNotSuccessful'] = '<b>ההתקנה של '
                                       . $phpAds_productname
                                       . 'לא הצליחה</b><br><br>חלקים מסוימים מתהליך ההתקנה לא הושלמו. אפשר שבעיות אלו הן זמניות בלבד, במקרה זה פשוט לחץ <b>המשך</b> ותחזור לשלב הראשון של תהליך ההתקנה. אם אתה רוצה לדעת יותר מה אומרות הודעות השגיאה מטה, וכיתד לפתור אותן, אנא היוועץ בתיעוד המצורף.';
...
$GLOBALS['strDayFullNames'] = ['ראשון', 'שני', 'שלישי', 'רביעי', 'חמישי', 'שישי', 'שבת'];

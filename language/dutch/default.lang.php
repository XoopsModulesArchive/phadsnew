...
$GLOBALS['strMonth'] = ['januari', 'februari', 'maart', 'april', 'mei', 'juni', 'juli', 'augustus', 'september', 'oktober', 'november', 'december'];
$GLOBALS['strDayShortCuts'] = ['zo', 'ma', 'di', 'wo', 'do', 'vr', 'za'];
$GLOBALS['strHour'] = 'Uur';
...
$GLOBALS['strConvertSWF'] = '<br>Het Flash bestand dat u zojuist upgeload heeft bevat vaste links. Pas als deze vaste links geconverteerd zijn zal '
                                 . $phpAds_productname
...
$GLOBALS['strErrorDBSubmitBug'] = 'Indien dit probleem te reproduceren is, dan is het mogelijk dat het veroorzaakt wordt door een fout in '
                                      . $phpAds_productname
                                      . '. Reporteer de volgende gegevens aan de makers van '
                                      . $phpAds_productname
                                      . '. Probeer tevens de actie die deze fout tot gevolg hebben zo duidelijk mogelijk te omschrijven.';
$GLOBALS['strMaintenanceNotActive'] = 'Het onderhoudsscript heeft niet gedraaid in de laatste 24 uur. \\nHet script moet elk uur gedraaid worden ander zal '
                                      . $phpAds_productname

...
$GLOBALS['strUpdateDatabaseError'] = 'Wegens een onbekende reden is het aanpassen van de database structuur niet gelukt. Het is aan te raden om te klikken op <b>Probeer opnieuw</b> om te proberen om deze fouten te herstellen. Indien u er zeker van bent dat deze fouten het functioneren van '
                                           . $phpAds_productname
                                           . ' niet in gevaar brengen kunt op de knop <b>Negeer foutmeldingen</b> klikken. Het negeren van deze foutmelding kan ernstige problemen veroorzaken en is niet aan te raden!';
...
$GLOBALS['strCouldNotConnectToDB'] = 'Er kon geen connectie opgebouwd worden met de database, controleer a.u.b. de door u opgegeven instellingen. Ook dient u te controleren op de database die u opgegeven heeft ook daadwerkelijk bestaat op de database server. '
                                           . $phpAds_productname
                                           . ' zal deze database niet zelf aanmaken, deze moet al aangemaakt zijn voordat u de installatie begint.';
...
$GLOBALS['strConfigLockedDetected'] = $phpAds_productname
                                           . ' heeft gedetecteerd dat uw <b>config.inc.php</b> bestand niet beschrijfbaar is door de server. U kunt niet verder gaan tot u de bestands permissies gewijzigd heeft. Raadpleeg de bijgevoegde documentatie indien u niet weet hoe u dit kunt doen.';
...
$GLOBALS['strDayFullNames'] = ['zondag', 'maandag', 'dinsdag', 'woensdag', 'donderdag', 'vrijdag', 'zaterdag'];

...
$GLOBALS['strMonth'] = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
$GLOBALS['strDayShortCuts'] = ['Su', 'Mo', 'Tu', 'We', 'Th', 'Fr', 'Sa'];
...
$GLOBALS['strMaintenanceNotActive'] = 'The maintenance script has not been run in the last 24 hours. \\nIn order for '
                                      . $phpAds_productname
                                      . ' to function correctly it needs to run \\nevery hour. \\n\\nPlease read the Administrator guide for more information \\nabout configuring the maintenance script.';

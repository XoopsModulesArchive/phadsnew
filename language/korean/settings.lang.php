...
$GLOBALS['strDayFullNames'] = ['일요일', '월요일', '화요일', '수요일', '목요일', '금요일', '토요일'];
$GLOBALS['strEditConfigNotPossible'] = '보안상 설정 파일이 잠겨있기 때문이 설정을 변경할 수 없습니다. ' . '설정을 변경하려면 config.inc.php 파일의 잠금을 해제하십시오.';
$GLOBALS['strEditConfigPossible'] = '설정 파일이 잠겨있지 않기 때문에 모든 설정을 편집하는 것이 가능하지만, 이로인해 보안 문제가 발생할 수 있습니다.' . '시스템을 안전하게 하려면 config.inc.php 파일에 잠금을 설정해야 합니다.';

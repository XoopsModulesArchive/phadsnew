...
if (phpAds_isUser(phpAds_Admin)) {
    ...
    phpAds_ShowSections(['2.1.1', '2.1.2']);
}
...
if (phpAds_isUser(phpAds_Client)) {
    ...
    if ($phpAds_config['client_welcome']) {
        ...
        if (!empty($phpAds_client_welcome_msg)) {
            ...
            require __DIR__ . '/templates/welcome-advertiser.html';
        }

        echo '<br><br>';
    }

    phpAds_ShowSections(['1.1', '1.2']);
}
...
if (!isset($hideinactive)) {
    $hideinactive = $Session['prefs']['stats-client-campaigns.php']['hideinactive'] ?? ('t' == $phpAds_config['gui_hide_inactive']);
}
...
if ($phpAds_config['compact_stats']) {
    ...
    while (false !== ($row_stats = phpAds_dbFetchArray($res_stats))) {

...
if (!$phpAds_config['compact_stats']) {
    $begin = date('YmdHis', mktime(0, 0, 0, mb_substr($day, 4, 2), mb_substr($day, 6, 2), mb_substr($day, 0, 4)));

    $end = date('YmdHis', mktime(0, 0, 0, mb_substr($day, 4, 2), mb_substr($day, 6, 2) + 1, mb_substr($day, 0, 4)));
    ...
    while (false !== ($row = phpAds_dbFetchArray($result))) {
        ...
        if (preg_match('[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}', $row['host'])) {
        ...
        $flag = ('' == $row['country'] || 'A1' == $row['country'] || 'A2' == $row['country']) ? 'unknown' : mb_strtolower($row['country']);
    ...
    */
    ...
    while (false !== ($row = phpAds_dbFetchArray($result))) {
        ...
        echo '' != $row['country'] ? "<img src='images/flags/" . mb_strtolower($row['country']) . ".gif' width='19' height'11'>&nbsp;" . $phpAds_ISO3166[$row['country']] : '-';
    ...
    while (false !== ($row = phpAds_dbFetchArray($result))) {
        ...
        echo '' != $row['country'] ? "<img src='images/flags/" . mb_strtolower($row['country']) . ".gif' width='19' height'11'>&nbsp;" . $phpAds_ISO3166[$row['country']] : $strUnknown;

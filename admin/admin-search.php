...
if (false === $client && false === $campaign
    && false === $banner && false === $zone
    && false === $affiliate) {
    $client = true;
...
<html<?php echo 'ltr' != $phpAds_TextDirection ? " dir='" . $phpAds_TextDirection . "'" : '' ?>>
<head>
...
<table width='100%' border='0' cellspacing='0' cellpadding='0'>
    ...
    <!-- Spacer -->
    <tr>
        <td colspan='2' height='24' bgcolor='#000063'><img src='images/spacer.gif' height='1' width='1'></td>
    </tr>
        ...
        <td colspan='2' height='24' bgcolor="#000063">
            <table cellpadding='0' cellspacing='0' border='0' bgcolor='#FFFFFF' height='24'>
                <form name='search' action='admin-search.php' method='post'>
                    ...
                    <tr height='24'>
                        <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td class='tab-s' valign='bottom'><?php echo $strSearch; ?>:&nbsp;<input type='text' name='keyword' size='15' value='<?php print $keyword ?>' accesskey='<?php print $keySearch ?>'>&nbsp;
    ...
    <tr>
        ...
        <td>
            ...
            if (phpAds_dbNumRows($res_clients) > 0
                || phpAds_dbNumRows($res_campaigns) > 0 || phpAds_dbNumRows($res_banners) > 0 || phpAds_dbNumRows($res_affiliates) > 0
            ...
            if ($client && phpAds_dbNumRows($res_clients) > 0) {
                while (false !== ($row_clients = phpAds_dbFetchArray($res_clients))) {
                    if ($i > 0) {
                    ...
                    echo "<a href='JavaScript:GoOpener(\"client-delete.php?clientid="
                         . $row_clients['clientid']
                         . "\", true)'"
                         . phpAds_DelConfirm($strConfirmDeleteClient)
                    ...
                    if (!$compact) {
                        ...
                        while (false !== ($row_c_expand = phpAds_dbFetchArray($res_c_expand))) {
                            ...
                            echo "<a href='JavaScript:GoOpener(\"campaign-banners.php?clientid="
                                 . $row_clients['clientid']
                                 . '&campaignid='
                                 . $row_c_expand['clientid']
                                 . "\")'><img src='images/icon-overview.gif' border='0' align='absmiddle' alt='$strOverview'>&nbsp;$strOverview</a>&nbsp;&nbsp;&nbsp;&nbsp;";
                            ...
                            echo "<a href='JavaScript:GoOpener(\"campaign-delete.php?clientid="
                                 . $row_clients['clientid']
                                 . '&campaignid='
                                 . $row_c_expand['clientid']
                                 . "\", true)'"
                                 . phpAds_DelConfirm($strConfirmDeleteCampaign)
                                 . "><img src='images/icon-recycle.gif' border='0' align='absmiddle' alt='$strDelete'>&nbsp;$strDelete</a>&nbsp;&nbsp;&nbsp;&nbsp;";
                            ...
                            while (false !== ($row_b_expand = phpAds_dbFetchArray($res_b_expand))) {
                                $name = $strUntitled;

                                if (isset($row_b_expand['alt']) && '' != $row_b_expand['alt']) {
                                    $name = $row_b_expand['alt'];
                                }

                                if (isset($row_b_expand['description']) && '' != $row_b_expand['description']) {
                                    $name = $row_b_expand['description'];
                                }
                                ...
                                if ('html' == $row_b_expand['storagetype']) {
                                    echo "<img src='images/icon-banner-html.gif' align='absmiddle'>&nbsp;";
                                } elseif ('url' == $row_b_expand['storagetype']) {
                                ...
                                echo "<a href='JavaScript:GoOpener(\"banner-acl.php?clientid="
                                     . $row_clients['clientid']
                                     . '&campaignid='
                                     . $row_b_expand['clientid']
                                     . '&bannerid='
                                     . $row_b_expand['bannerid']
                                     . "\")'><img src='images/icon-acl.gif' border='0' align='absmiddle' alt='$strACL'>&nbsp;$strACL</a>&nbsp;&nbsp;&nbsp;&nbsp;";
                                ...
                                echo "<a href='JavaScript:GoOpener(\"banner-delete.php?clientid="
                                     . $row_clients['clientid']
                                     . '&campaignid='
                                     . $row_b_expand['clientid']
                                     . '&bannerid='
                                     . $row_b_expand['bannerid']
                                     . "\", true)'"
                                     . phpAds_DelConfirm($strConfirmDeleteBanner)
                                     . "><img src='images/icon-recycle.gif' border='0' align='absmiddle' alt='$strDelete'>&nbsp;$strDelete</a>&nbsp;&nbsp;&nbsp;&nbsp;";
            ...
            if ($campaign && phpAds_dbNumRows($res_campaigns) > 0) {
                while (false !== ($row_campaigns = phpAds_dbFetchArray($res_campaigns))) {
                    if ($i > 0) {
                        echo "<tr height='1'><td colspan='5' bgcolor='#888888'><img src='images/break-l.gif' height='1' width='100%'></td></tr>";
                    }
                    ...
                    echo "<a href='JavaScript:GoOpener(\"campaign-banners.php?clientid="
                         . $row_campaigns['parent']
                         . '&campaignid='
                         . $row_campaigns['clientid']
                         . "\")'><img src='images/icon-overview.gif' border='0' align='absmiddle' alt='$strOverview'>&nbsp;$strOverview</a>&nbsp;&nbsp;&nbsp;&nbsp;";
            ...
            if ($banner && phpAds_dbNumRows($res_banners) > 0) {
                while (false !== ($row_banners = phpAds_dbFetchArray($res_banners))) {
                    ...
                    if (isset($row_banners['alt']) && '' != $row_banners['alt']) {
                        $name = $row_banners['alt'];
                    }

                    if (isset($row_banners['description']) && '' != $row_banners['description']) {
                    ...
                    if ('html' == $row_banners['storagetype']) {
                        echo "<img src='images/icon-banner-html.gif' align='absmiddle'>&nbsp;";
                    } elseif ('url' == $row_banners['storagetype']) {
                        echo "<img src='images/icon-banner-url.gif' align='absmiddle'>&nbsp;";
                    } else {
                        echo "<img src='images/icon-banner-stored.gif' align='absmiddle'>&nbsp;";
                    }
                    ...
                    echo "<a href='JavaScript:GoOpener(\"banner-acl.php?clientid="
                         . phpAds_getParentID($row_banners['clientid'])
                         . '&campaignid='
                         . $row_banners['clientid']
                         . '&bannerid='
                         . $row_banners['bannerid']
                         . "\")'><img src='images/icon-acl.gif' border='0' align='absmiddle' alt='$strACL'>&nbsp;$strACL</a>&nbsp;&nbsp;&nbsp;&nbsp;";
            ...
            if ($affiliate && phpAds_dbNumRows($res_affiliates) > 0) {
                while (false !== ($row_affiliates = phpAds_dbFetchArray($res_affiliates))) {
                    ...
                    echo "<a href='JavaScript:GoOpener(\"affiliate-delete.php?affiliateid="
                         . $row_affiliates['affiliateid']
                         . "\", true)'"
                         . phpAds_DelConfirm($strConfirmDeleteAffiliate)
                         . "><img src='images/icon-recycle.gif' border='0' align='absmiddle' alt='$strDelete'>&nbsp;$strDelete</a>&nbsp;&nbsp;&nbsp;&nbsp;";
                    ...
                    if (!$compact) {
                        ...
                        while (false !== ($row_z_expand = phpAds_dbFetchArray($res_z_expand))) {
                            ...
                            echo "<a href='JavaScript:GoOpener(\"zone-include.php?affiliateid="
                                 . $row_z_expand['affiliateid']
                                 . '&zoneid='
                                 . $row_z_expand['zoneid']
                                 . "\")'><img src='images/icon-zone-linked.gif' border='0' align='absmiddle' alt='$strIncludedBanners'>&nbsp;$strIncludedBanners</a>&nbsp;&nbsp;&nbsp;&nbsp;";
                            ...
                            echo "<a href='JavaScript:GoOpener(\"zone-delete.php?affiliateid="
                                 . $row_z_expand['affiliateid']
                                 . '&zoneid='
                                 . $row_z_expand['zoneid']
                                 . "\", true)'"

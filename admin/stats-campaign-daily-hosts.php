...
if (phpAds_isUser(phpAds_Admin)) {
    ...
    echo "<img src='images/icon-date.gif' align='absmiddle'>&nbsp;<b>" . date(str_replace('%', '', $date_format), mktime(0, 0, 0, mb_substr($day, 4, 2), mb_substr($day, 6, 2), mb_substr($day, 0, 4))) . '</b><br><br><br>';

    phpAds_ShowSections(['2.1.2.1.1', '2.1.2.1.2']);
}
...
if (phpAds_isUser(phpAds_Client)) {
    ...
    echo "<img src='images/icon-date.gif' align='absmiddle'>&nbsp;<b>" . date(str_replace('%', '', $date_format), mktime(0, 0, 0, mb_substr($day, 4, 2), mb_substr($day, 6, 2), mb_substr($day, 0, 4))) . '</b><br><br>';

    phpAds_ShowSections(['1.2.1.1', '1.2.1.2']);
}

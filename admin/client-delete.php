...
if (isset($clientid) && '' != $clientid) {
    ...
    while (false !== ($row_campaign = phpAds_dbFetchArray($res_campaign))) {
        // Delete Campaign
        ...
        while (false !== ($row = phpAds_dbFetchArray($res_banners))) {
            // Cleanup stored images for each banner

            if (('web' == $row['storagetype'] || 'sql' == $row['storagetype']) && '' != $row['filename']) {

...
phpAds_ShowSections(['2.1.2.2.1', '2.1.2.2.2']);
...
for ($i = 0, $iMax = count($node_array); $i < $iMax; $i++) {
...
if (isset($affiliates) && is_array($affiliates) && count($affiliates) > 0) {
    ...
    for (reset($affiliates); $key = key($affiliates); next($affiliates)) {
        ...
        if (isset($affiliates[$key]['zones']) && count($affiliates[$key]['zones']) > 0) {
            ...
            if ($affiliate['views'] || $affiliate['clicks']) {
                ...
                if (isset($affiliate['zones'])) {
                    if ('1' == $affiliate['expand']) {
                        ...
                        echo "&nbsp;<a href='stats-banner-affiliates.php?clientid="
                             . $clientid
                             . '&campaignid='
                             . $campaignid
                             . '&bannerid='
                             ...
                             . "/triangle-l.gif' align='absmiddle' border='0'></a>&nbsp;";
                    }
                } else {
                ...
                if (isset($affiliate['zones']) && count($affiliate['zones']) > 0 && '1' == $affiliate['expand']) {
                    ...
                    for (reset($zones); $zkey = key($zones); next($zones)) {
                        if ($zones[$zkey]['views'] || $zones[$zkey]['clicks']) {
                            ...
                            if ('' != $zones[$zkey]['what']) {
                                if (phpAds_ZoneBanner == $zones[$zkey]['delivery']) {
                                    echo "<img src='images/icon-zone.gif' align='absmiddle'>&nbsp;";
                                } elseif (phpAds_ZoneInterstitial == $zones[$zkey]['delivery']) {
                                    echo "<img src='images/icon-interstitial.gif' align='absmiddle'>&nbsp;";
                                } elseif (phpAds_ZonePopup == $zones[$zkey]['delivery']) {
                                    echo "<img src='images/icon-popup.gif' align='absmiddle'>&nbsp;";
                                } elseif (phpAds_ZoneText == $zones[$zkey]['delivery']) {

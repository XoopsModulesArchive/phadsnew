...
if (!isset($banners) || !is_array($banners) || 0 == count($banners)) {
    ...
    for (reset($banners); $bkey = key($banners); next($banners)) {
        ...
        if ($phpAds_config['gui_show_banner_info']) {
            ...
            if ('txt' == $banners[$bkey]['storagetype']) {
        ...
        if (1 == $banners[$bkey]['expand'] || $phpAds_config['gui_show_campaign_preview']) {
            if (!$phpAds_config['gui_show_banner_info']) {
                echo '<tr ' . (0 == $i % 2 ? "bgcolor='#F6F6F6'" : '') . "><td colspan='1'>&nbsp;</td><td colspan='4'>";
            }

            echo '<tr ' . (0 == $i % 2 ? "bgcolor='#F6F6F6'" : '') . "><td colspan='5'>";
...
if (isset($banners) && count($banners)) {
    echo "<img src='images/icon-recycle.gif' border='0' align='absmiddle'>&nbsp;<a href='banner-delete.php?clientid="
         . $clientid
         . '&campaignid='
         . $campaignid
         . "&returnurl=campaign-banners.php'"
         . phpAds_DelConfirm($strConfirmDeleteAllBanners)
         . ">$strDeleteAllBanners</a>&nbsp;&nbsp;&nbsp;&nbsp;";
}

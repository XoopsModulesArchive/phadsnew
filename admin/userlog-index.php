...
if ('english' != $phpAds_config['language'] && file_exists(phpAds_path . '/language/' . $phpAds_config['language'] . '/userlog.lang.php')) {
...
while (false !== ($row = phpAds_dbFetchArray($res))) {
    ...
    switch ($row['usertype']) {
        case phpAds_userDeliveryEngine:
            echo "<img src='images/icon-generatecode.gif' align='absmiddle'>&nbsp;" . $strDeliveryEngine;
            break;
        case phpAds_userMaintenance:
            echo "<img src='images/icon-time.gif' align='absmiddle'>&nbsp;" . $strMaintenance;
            break;
        case phpAds_userAdministrator:
            echo "<img src='images/icon-client.gif' align='absmiddle'>&nbsp;" . $strAdministrator;
            break;
    }
    ...
    echo "<tr height='20' valign='top' " . (0 == $i % 2 ? "bgcolor='#F6F6F6'" : '') . '>';

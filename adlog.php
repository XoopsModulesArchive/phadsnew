...
if (isset($bannerid) && isset($clientid) && isset($zoneid)) {
    ...
    if (0 == $phpAds_config['block_adviews']
        || ($phpAds_config['block_adviews'] > 0
            && (!isset($HTTP_COOKIE_VARS['phpAds_blockView'][$bannerid]) || $HTTP_COOKIE_VARS['phpAds_blockView'][$bannerid] <= time()))) {
        ...
        if ($phpAds_config['block_adviews'] > 0) {
            phpAds_setCookie(
                'phpAds_blockView[' . $bannerid . ']',
                time() + $phpAds_config['block_adviews'],
                time() + $phpAds_config['block_adviews'] + 43200
            );
        }
    }

    if (isset($block) && '' != $block && '0' != $block) {
        phpAds_setCookie('phpAds_blockAd[' . $bannerid . ']', time() + $block, time() + $block + 43200);
    }

    if (isset($capping) && '' != $capping && '0' != $capping) {
    ...
    if ('' != $phpAds_config['geotracking_type'] && $phpAds_config['geotracking_cookie']) {
        if (!isset($HTTP_COOKIE_VARS['phpAds_geoInfo']) && $phpAds_geo) {
            phpAds_setCookie(
                'phpAds_geoInfo',
                ($phpAds_geo['country'] ?: '') . '|' . ($phpAds_geo['continent'] ?: '') . '|' . ($phpAds_geo['region'] ?: ''),
                0
            );
        }
    }
...
// 1 x 1 gif
echo chr(0x47) . chr(0x49) . chr(0x46) . chr(0x38) . chr(0x39) . chr(0x61) . chr(0x01) . chr(0x00) . chr(0x01) . chr(0x00) . chr(0x80) . chr(0x00) . chr(0x00) . chr(0x04) . chr(0x02) . chr(0x04) . chr(0x00) . chr(0x00) . chr(0x00) . chr(0x21) . chr(0xF9) . chr(0x04) . chr(0x01) . chr(0x00) . chr(
    0x00
) . chr(0x00) . chr(0x00) . chr(0x2C) . chr(0x00) . chr(0x00) . chr(0x00) . chr(0x00) . chr(0x01) . chr(0x00) . chr(0x01) . chr(0x00) . chr(0x00) . chr(0x02) . chr(0x02) . chr(0x44) . chr(0x01) . chr(0x00) . chr(0x3B);

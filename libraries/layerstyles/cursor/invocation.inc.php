...
function phpAds_placeLayerSettings()
{
    ...
    echo "<option value='1'" . ('1' == $trail ? ' selected' : '') . '>' . $GLOBALS['strYes'] . '</option>';

    echo "<option value='0'" . ('0' == $trail ? ' selected' : '') . '>' . $GLOBALS['strNo'] . '</option>';
    ...
    echo "<select name='stickyness' style='width:60px;'" . ('0' == $trail ? ' disabled' : '') . " tabindex='" . ($tabindex++) . "'>";
    ...
    echo "<option value='1'" . ('1' == $hide ? ' selected' : '') . '>' . $GLOBALS['strYes'] . '</option>';

    echo "<option value='0'" . ('0' == $hide ? ' selected' : '') . '>' . $GLOBALS['strNo'] . '</option>';
    ...
    echo "<input class='flat' type='text' name='delay' size='' value='" . $delay . "' style='width:60px;'" . ('0' == $hide ? ' disabled' : '') . " tabindex='" . ($tabindex++) . "'> ms</td></tr>";
    ...
    echo "<select name='transparancy' style='width:60px;'" . ('0' == $hide ? ' disabled' : '') . " tabindex='" . ($tabindex++) . "'>";

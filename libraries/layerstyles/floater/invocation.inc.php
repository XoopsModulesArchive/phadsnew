...
function phpAds_placeLayerSettings()
{
    ...
    echo "<option value='t'" . ('t' == $ltr ? ' selected' : '') . '>' . $GLOBALS['strLeftToRight'] . '</option>';

    echo "<option value='f'" . ('f' == $ltr ? ' selected' : '') . '>' . $GLOBALS['strRightToLeft'] . '</option>';
    ...
    echo "<option value='n'" . ('n' == $loop ? ' selected' : '') . '>' . $GLOBALS['strAlwaysActive'] . '</option>';
    ...
    echo "<option value='t'" . ('t' == $limited ? ' selected' : '') . '>' . $GLOBALS['strYes'] . '</option>';

    echo "<option value='f'" . ('f' == $limited ? ' selected' : '') . '>' . $GLOBALS['strNo'] . '</option>';
    ...
    echo "<input class='flat' type='text' name='lmargin' size='' tabindex='" . ($tabindex++) . "' value='" . $lmargin . "' style='width:60px;'" . ('f' == $limited ? ' disabled' : '') . '> ' . $GLOBALS['strAbbrPixels'] . '</td></tr>';
    ...
    echo "<input class='flat' type='text' name='rmargin' size='' tabindex='" . ($tabindex++) . "' value='" . $rmargin . "' style='width:60px;'" . ('f' == $limited ? ' disabled' : '') . '> ' . $GLOBALS['strAbbrPixels'] . '</td></tr>';
    ...
    echo "<option value='t'" . ('t' == $transparent ? ' selected' : '') . '>' . $GLOBALS['strYes'] . '</option>';

    echo "<option value='f'" . ('f' == $transparent ? ' selected' : '') . '>' . $GLOBALS['strNo'] . '</option>';
    ...
    echo "<input type='text' class='flat' name='backcolor' size='10' maxlength='7' tabindex='"
         . ($tabindex++)
         . "' value='"
         . $backcolor
         . "'"
         . ('t' == $transparent ? ' disabled' : '')
         . " onFocus='current_cp = this; current_cp_oldval = this.value; current_box = backcolor_box' onChange='c_update()'>";
...
function phpAds_generateLayerCode($parameters)
{
    ...
    $parameters[] = 'ltr=' . ($ltr ?? 't');

    $parameters[] = 'loop=' . ($loop ?? 'n');

    $parameters[] = 'speed=' . ($speed ?? 3);

    $parameters[] = 'pause=' . ($pause ?? 10);

    $parameters[] = 'shiftv=' . ($shiftv ?? 0);

    $parameters[] = 'transparent=' . ($transparent ?? 't');

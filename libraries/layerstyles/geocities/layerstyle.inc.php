...
function phpAds_getLayerLimitations()
{
    ...
    $compatible = 'IE' == $agent['agent'] && $agent['version'] < 5.0 || 'Mozilla' == $agent['agent'] && $agent['version'] < 5.0 || 'Opera' == $agent['agent'] && $agent['version'] < 5.0 ? false : true;

    $richmedia = 'Win' == $agent['platform'] ? true : false;
...
<div id="phpads_c'
           ...
           . 'px; height:'
           . $layer_height
           . 'px; z-index:98; left: 0px; top: 0px; visibility: hidden"> 
	<table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-style: ridge; border-color: #ffffff">
		<tr>
			<td bordercolor="#DDDDDD" bgcolor="#000099" align="right" style="padding: 3px 3px 2px"><img src="'
           . $imagepath
           . 'expand.gif" width="12" height="12" hspace="3" onClick="phpAds_geopop(\'expand\', \''
           . $uniqid
           . '\')"><img src="'
           . $imagepath
           . 'close.gif" width="12" height="12" onClick="phpAds_geopop(\'close\', \''
           . $uniqid
           . '\')"></td>
		</tr>
'
           . (mb_strlen($output['url']) && mb_strlen($output['alt']) ? '		<tr>
...
<div id="phpads_o'
           ...
           . 'px; height:'
           . $layer_height
           . 'px; z-index:99; left: 0px; top: 0px; visibility: hidden"> 
	<table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-style: outset; border-color: #ffffff">
		<tr> 
			<td bordercolor="#DDDDDD" bgcolor="#000099" align="right" style="padding: 3px 3px 2px"><img src="'
           . $imagepath
           . 'expand-d.gif" width="12" height="12" hspace="3"><img src="'
           . $imagepath
           . 'collapse.gif" width="12" height="12" onClick="phpAds_geopop(\'collapse\', \''
           . $uniqid
           . '\')"></td>
		</tr>
		<tr> 
           ...
           . '" height="'
           . $output['height']
           . '" align="center" valign="middle" style="padding: '
           . $padding
           . 'px">'
           . $output['html']
           . '</td>
